...
const InventarDepozitPage = lazyPage(
  () => import("./pages/InventarDepozitPage"),
  {
    preload: true,
    minDisplayTime: 300,
  }
...
const AdminUsersManagementPage = lazyPage(() => import("./pages/admin/UsersManagementPage"));
const AdminRoleManagementPage = lazyPage(() => import("./pages/admin/RoleManagementPage"));
const AdminLogsPage = lazyPage(() => import("./pages/admin/LogsPage"));
const AdminSystemSettingsPage = lazyPage(() => import("./pages/admin/SystemSettingsPage"));
