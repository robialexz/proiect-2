...
const DashboardPage = () => {
  ...
  // Am eliminat starea și efectul pentru prima animație (cea mică)
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-slate-900 to-slate-800 text-white relative">
      ...
      {/* Am eliminat prima animație (cea mică) */}

      <div className="flex-1 relative z-10">
        {/* Header îmbunătățit cu gradient și umbre */}
        <motion.header
          className="bg-gradient-to-r from-slate-900 to-slate-800 border-b border-slate-700/50 px-4 py-3 backdrop-blur-sm shadow-lg shadow-slate-900/20"
        ...
        <main className="p-3">
          ...
          >
            {/* Statistici îmbunătățite cu efecte hover și animații - redimensionate pentru a evita scroll-ul */}
                ...
                <Card className="bg-slate-800/80 backdrop-blur-sm border-slate-700 overflow-hidden relative shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <CardContent className="relative z-10 pt-4">
                    <div className="space-y-4">
                      {/* Skeleton loader pentru activități - redus pentru a evita scroll-ul */}
