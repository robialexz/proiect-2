...
const Sidebar = () => {
  ...
  const navGroups: NavGroup[] = useMemo(
    () => [
      // Grupul de administrare - vizibil doar pentru administratori
      ...(userRole === UserRoles.ADMIN
        ? [
            {
              title: t("sidebar.adminGroup", "Administrare"),
              icon: <Shield size={20} />,
              items: [
                {
                  title: t("sidebar.adminDashboard", "Panou Admin"),
                  icon: <LayoutDashboard size={20} />,
                  href: "/admin",
                },
                {
                  title: t("sidebar.adminUsers", "Utilizatori"),
                  icon: <Users size={20} />,
                  href: "/admin/users",
                },
                {
                  title: t("sidebar.adminRoles", "Roluri"),
                  icon: <Shield size={20} />,
                  href: "/admin/roles",
                },
                {
                  title: t("sidebar.adminLogs", "Jurnale"),
                  icon: <FileText size={20} />,
                  href: "/admin/logs",
                },
                {
                  title: t("sidebar.adminSettings", "Setări Sistem"),
      ...
      },
      {
        ...
        items: [
          ...
          {
            title: t("sidebar.auctions", "Licitații"),
            icon: <Gavel size={20} />,
            href: "/auctions",
            badge: "Nou",
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto py-4">
        <nav className="px-2 space-y-1">
          {/* Buton Panou Control direct în meniu */}
          <div className="mb-4">
            <TooltipProvider>
              <Tooltip>
      ...
      <div className="p-4 border-t border-slate-800">
        {/* Dropdown pentru butoanele de jos */}
          ...
          {!collapsed ? (
            <div className="space-y-2">
              ...
              >
                <div className="flex items-center">
                  <Settings size={20} />
                  <span className="ml-3">{t("sidebar.tools", "Unelte și Setări")}</span>
                </div>
                <ChevronDown
                  size={16}
                  className={cn(
                    "transition-transform duration-200",
                    expandedGroups["tools"] ? "transform rotate-180" : ""
                  )}
                />
              </button>

              {expandedGroups["tools"] && (
                <div className="ml-2 space-y-1 border-l border-slate-800 pl-2">
                  ...
                  <SystemHealthSidebarItem collapsed={false} />
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent side="right">
                  <p>{t("sidebar.tools", "Unelte și Setări")}</p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          )}
