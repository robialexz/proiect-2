...
const ExpensesList: React.FC<ExpensesListProps> = ({
  ...
  const fetchExpenses = async () => {
    ...
    try {
      ...
      // Since the expenses table doesn't exist, we'll use mock data
      // This is a temporary solution until the expenses table is created
      const mockData = [];

      setExpenses(mockData);

      // Calculate total spent (will be 0 with mock data)
      const total = 0;
      setTotalSpent(total);
