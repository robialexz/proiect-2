...
export function isAuthError(error: any): boolean {
  ...
  if (error.message) {
    ...
    if (authErrorMessages.some(msg => error.message.toLowerCase().includes(msg))) {
      return true;
    }
  }
  ...
  if (error.code) {
    ...
    if (
      ...
      return {
        ...
        message: 'Credențiale invalide. Vă rugăm să verificați email-ul și parola.',
        code: error.code,
        recoverable: true
      };
    }
    ...
    if (error.code.includes('auth/email-not-verified')) {
      return {
        ...
        message: 'Email-ul nu a fost confirmat. Vă rugăm să verificați email-ul pentru link-ul de confirmare.',
        code: error.code,
        recoverable: true
      };
    }
    ...
    if (
      ...
      return {
        ...
        message: 'Token de autentificare invalid. Vă rugăm să vă autentificați din nou.',
        code: error.code,
        recoverable: true
      };
    }
