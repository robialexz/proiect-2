    ...
    translation: {
      ...
      "inventory": {
          ...
          "adjustDialog": {
              ...
              "description": "Adjust supplementary quantity for {{materialName}}. Current: {{currentValue}}",
          ...
          "confirmDialog": {
              ...
              "description": "Confirm procurement status for {{materialName}} (Requested: {{requestedValue}}).",
          ...
          "errors": {
              ...
              "confirmFailed": "Failed to confirm supplementary quantity via function: {{details}}",
              "confirmFunctionError": "Function failed to confirm quantity: {{details}}",
              "unexpectedConfirmError": "An unexpected error occurred during confirmation: {{message}}",
              "deleteFailed": "Failed to delete material via function: {{details}}",
              "deleteFunctionError": "Function failed to delete material: {{details}}",
              ...
              "adjustFailed": "Failed to adjust supplementary quantity via function: {{details}}",
              "adjustFunctionError": "Function failed to adjust quantity: {{details}}",
              "unexpectedAdjustError": "An unexpected error occurred during adjustment: {{message}}",
              "fetchFailed": "Failed to load materials. {{message}}"
          },
          "columns": { // Add keys for column headers
              "name": "Name",
              "dimension": "Dimension",
              "unit": "Unit",
              "quantity": "Quantity",
          ...
          "actions": { // Add keys for dropdown actions
              "openMenu": "Open menu",
      ...
      "language": "Limbă",
       ...
       "inventory": {
          ...
          "deleteDialog": {
              ...
              "description": "Această acțiune nu poate fi anulată. Va șterge permanent materialul"
          },
          "adjustDialog": {
              "title": "Ajustează Cantitate Suplimentară",
              "description": "Ajustează cantitatea suplimentară pentru {{materialName}}. Curent: {{currentValue}}",
          ...
          "confirmDialog": {
              ...
              "description": "Confirmă statusul achiziției pentru {{materialName}} (Cerut: {{requestedValue}}).",
           ...
           "errors": {
              ...
              "invalidConfirmationOption": "Opțiune de confirmare invalidă selectată.",
              "confirmFailed": "Eșec la confirmarea cantității suplimentare via funcție: {{details}}",
              "confirmFunctionError": "Funcția a eșuat la confirmarea cantității: {{details}}",
              "unexpectedConfirmError": "Eroare neașteptată la confirmare: {{message}}",
              "deleteFailed": "Eșec la ștergerea materialului via funcție: {{details}}",
              "deleteFunctionError": "Funcția a eșuat la ștergerea materialului: {{details}}",
              "unexpectedDeleteError": "Eroare neașteptată la ștergere: {{message}}",
              "invalidAdjustmentQuantity": "Cantitate invalidă introdusă pentru ajustare.",
              "adjustFailed": "Eșec la ajustarea cantității suplimentare via funcție: {{details}}",
              "adjustFunctionError": "Funcția a eșuat la ajustarea cantității: {{details}}",
       ...
       "inventory": {
          ...
          "overviewTitle": "Aperçu Inventaire",
           "addDialog": {
              ...
              "description": "Entrez les détails. Cliquez sur enregistrer lorsque vous avez terminé."
          },
           "form": {
              "name": "Nom",
          ...
          "deleteDialog": {
              ...
              "description": "Cette action est irréversible. Cela supprimera définitivement le matériel"
          },
          "adjustDialog": {
              "title": "Ajuster Quantité Supplémentaire",
              "description": "Ajuster la quantité supplémentaire pour {{materialName}}. Actuel: {{currentValue}}",
          ...
          "confirmDialog": {
              ...
              "description": "Confirmer le statut d'approvisionnement pour {{materialName}} (Demandé: {{requestedValue}}).",
           ...
           "errors": { // Example error translations
              ...
              "unexpectedConfirmError": "Erreur inattendue lors de la confirmation: {{message}}",
              "deleteFailed": "Échec de la suppression via fonction: {{details}}",
              "deleteFunctionError": "La fonction a échoué à supprimer: {{details}}",
              "unexpectedDeleteError": "Erreur inattendue lors de la suppression: {{message}}",
              ...
              "unexpectedAdjustError": "Erreur inattendue lors de l'ajustement: {{message}}",
      ...
      // Add German translations for inventory section (example, needs proper translation)
       "inventory": {
          ...
          "deleteDialog": {
              ...
              "description": "Diese Aktion kann nicht rückgängig gemacht werden. Das Material wird dauerhaft gelöscht"
          },
          "adjustDialog": {
              "title": "Zusatzmenge Anpassen",
              "description": "Zusatzmenge für {{materialName}} anpassen. Aktuell: {{currentValue}}",
          ...
          "confirmDialog": {
              ...
              "description": "Beschaffungsstatus für {{materialName}} bestätigen (Angefordert: {{requestedValue}}).",
           ...
           "errors": { // Example error translations
              ...
              "unexpectedConfirmError": "Unerwarteter Fehler bei Bestätigung: {{message}}",
              "deleteFailed": "Löschen via Funktion fehlgeschlagen: {{details}}",
              "deleteFunctionError": "Funktion konnte nicht löschen: {{details}}",
              "unexpectedDeleteError": "Unerwarteter Fehler beim Löschen: {{message}}",
              ...
              "unexpectedAdjustError": "Unerwarteter Fehler bei Anpassung: {{message}}",
