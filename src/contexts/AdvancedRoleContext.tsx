...
const AdvancedRoleContext = createContext<AdvancedRoleContextType | undefined>(undefined);
...
const rolePermissionsMap: Record<UserRole, Permission[]> = {
  director_general: [
    ...
    'view_projects', 'create_project', 'edit_project', 'delete_project', 'assign_project',
    'view_inventory', 'add_material', 'edit_material', 'delete_material', 'adjust_stock', 'request_material', 'approve_request',
    'view_reports', 'create_report', 'export_report',
    'view_users', 'create_user', 'edit_user', 'delete_user', 'assign_role',
    'view_settings', 'edit_settings',
    'view_finances', 'create_invoice', 'approve_payment', 'view_budget', 'edit_budget',
    'view_hr', 'manage_attendance', 'manage_payroll', 'manage_benefits'
  ],
  director_executiv: [
    'view_dashboard', 'edit_profile',
    'view_projects', 'create_project', 'edit_project', 'assign_project',
    'view_inventory', 'add_material', 'edit_material', 'adjust_stock', 'approve_request',
    'view_reports', 'create_report', 'export_report',
    'view_users', 'create_user', 'edit_user',
    'view_settings',
    'view_finances', 'create_invoice', 'approve_payment', 'view_budget',
    'view_hr', 'manage_attendance'
  ],
  manager_departament: [
    'view_dashboard', 'edit_profile',
    'view_projects', 'create_project', 'edit_project', 'assign_project',
    'view_inventory', 'add_material', 'edit_material', 'adjust_stock', 'request_material',
    'view_reports', 'create_report', 'export_report',
    'view_users',
    'view_finances', 'view_budget'
  ],
  sef_proiect: [
    'view_dashboard', 'edit_profile',
    'view_projects', 'create_project', 'edit_project', 'assign_project',
  ...
  magazioner: [
    'view_dashboard', 'edit_profile',
    'view_inventory', 'add_material', 'edit_material', 'adjust_stock',
    'view_reports'
  ],
  operator_logistica: [
    'view_dashboard', 'edit_profile',
  ...
  administrator_sistem: [
    'view_dashboard', 'edit_profile',
    'view_projects', 'view_inventory', 'view_reports',
    'view_users', 'create_user', 'edit_user', 'delete_user', 'assign_role',
    'view_settings', 'edit_settings'
  ],
  contabil: [
    ...
    'view_inventory',
    'view_reports', 'create_report', 'export_report',
    'view_finances', 'create_invoice', 'view_budget'
  ],
  resurse_umane: [
    'view_dashboard', 'edit_profile',
    'view_users', 'create_user', 'edit_user',
...
export function AdvancedRoleProvider({ children }: { children: React.ReactNode }) {
  ...
  const fetchUserRole = async () => {
    ...
    try {
      ...
      const timeoutId = setTimeout(() => {
        if (isLoading) {
          console.log("Advanced role loading timeout reached, forcing loading to false");
          setIsLoading(false);
      ...
      const cachedRole = cacheService.get<UserRole>(cacheKey, { namespace: 'roles' });
  ...
  const getWelcomeMessage = (): string => {
    ...
    message = message.replace('{name}', name).replace('{count}', count.toString());
  ...
  return <AdvancedRoleContext.Provider value={value}>{children}</AdvancedRoleContext.Provider>;
}
...
export function useAdvancedRole() {
  ...
  if (context === undefined) {
    throw new Error('useAdvancedRole must be used within an AdvancedRoleProvider');
  }
  return context;
}
