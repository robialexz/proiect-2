...
const InventoryManagementPage = lazyPage(() => import('./pages/InventoryManagementPage'), {
  preload: true,
  minDisplayTime: 300
});

const CompanyInventoryPage = lazyPage(() => import('./pages/CompanyInventoryPage'), {
  preload: true,
  minDisplayTime: 300
});
...
const DashboardPage = lazyPage(() => import('./pages/DashboardPage'), { preload: true });
...
const ProjectsPage = lazyPage(() => import('./pages/ProjectsPage'), { preload: true });
...
const CategoryManagementPage = lazyPage(() => import('./pages/CategoryManagementPage'));
...
const UsersManagementPage = lazyPage(() => import('./pages/UsersManagementPage'));
const AuditLogsPage = lazyPage(() => import('./pages/AuditLogsPage'));
const AIInventoryAssistantPage = lazyPage(() => import('./pages/AIInventoryAssistantPage'));
