          ...
          >
            <div className="text-center py-12">
              <h3 className="text-xl font-medium mb-2">
                {t("teams.comingSoon.title", "Teams Management Coming Soon")}
              </h3>
              <p className="text-slate-400 max-w-md mx-auto mb-6">
                {t(
                  "teams.comingSoon.message",
                  "We're working on building a comprehensive team management system. Check back soon!",
                )}
              </p>
