          ...
          >
            <div className="text-center py-12">
              <h3 className="text-xl font-medium mb-2">
                {t("budget.comingSoon.title", "Budget Management Coming Soon")}
              </h3>
              <p className="text-slate-400 max-w-md mx-auto mb-6">
                {t(
                  "budget.comingSoon.message",
                  "We're working on building a comprehensive budget management system. Check back soon!",
                )}
              </p>
