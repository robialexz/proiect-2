        ...
        <AnimatePresence mode="wait">
          {error && (
            <motion.div
              ...
              className="mx-6 mt-4 bg-gradient-to-r from-red-500/20 to-red-500/10 border border-red-500/30 text-red-200 px-6 py-4 rounded-lg shadow-lg flex items-start"
              role="alert"
              aria-live="assertive"
            >
            ...
            {isLoading ? (
              <div className="space-y-4">
                {[...Array(3)].map((_, index) => (
                  <motion.div
                    key={index}
                    className="bg-slate-800/50 border border-slate-700/50 rounded-lg p-4 overflow-hidden"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                      <div className="space-y-3 w-full">
                        <div className="flex items-center">
                          ...
                          <div className="ml-2 h-6 w-16 bg-slate-700 rounded-full animate-pulse"></div>
                        </div>
                        <div className="h-3 w-2/3 bg-slate-700 rounded animate-pulse"></div>
                      ...
                      <div className="flex items-center space-x-2 mt-4 sm:mt-0">
                        <div className="h-9 w-9 bg-slate-700 rounded animate-pulse"></div>
                        <div className="h-9 w-9 bg-slate-700 rounded animate-pulse"></div>
                        <div className="h-9 w-9 bg-slate-700 rounded animate-pulse"></div>
                      </div>
                    </div>
              ...
              >
                ...
                >
                  {searchTerm || activeFilter
                    ? t("budgets.noSearchResults", "No budgets found")
                ...
                >
                  {searchTerm || activeFilter
                    ? t(
                        "budgets.noSearchResultsDesc",
                        "No budgets match your search criteria. Try adjusting your search term or create a new budget."
                      )
                    : t(
                        "budgets.noBudgetsDesc",
