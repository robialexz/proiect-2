            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              ...
              >
                ...
                <p className="text-lg md:text-xl text-slate-300 mb-8 max-w-xl mx-auto lg:mx-0">
                  A powerful platform designed for construction and engineering
                  teams to track, manage, and optimize inventory with real-time
                  insights.
                </p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-slate-400 max-w-2xl mx-auto">
                ...
                efficient inventory management across your projects
              </p>
            </motion.div>
        ...
        <section className="py-24">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-slate-400 max-w-2xl mx-auto">
                Choose the perfect plan for your team's needs with transparent
