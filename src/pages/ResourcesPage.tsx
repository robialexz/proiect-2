          ...
          >
            <div className="text-center py-12">
              <h3 className="text-xl font-medium mb-2">
                {t("resources.comingSoon.title", "Resources Coming Soon")}
              </h3>
              <p className="text-slate-400 max-w-md mx-auto mb-6">
                {t(
                  "resources.comingSoon.message",
                  "We're working on building a comprehensive resource management system. Check back soon!",
                )}
              </p>
