...
const InventoryOverviewPage: React.FC = () => {
  ...
  const loadStats = useCallback(async () => {
    try {
      ...
      const lowStockCount = materials.filter(item => 
  ...
  }, [user, loadRecentMaterials, loadLowStockItems, loadRecentActivity, loadStats]);
  ...
  const handleRefresh = () => {
    ...
    toast({
      ...
      description: t('inventory.refreshedDescription', 'Datele au fost actualizate cu succes'),
    });
  };
    ...
    try {
      ...
      if (data) {
        ...
        toast({
          ...
          description: t('inventory.exportedDescription', 'Inventarul a fost exportat cu succes'),
        });
      }
    } catch (err: any) {
  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      <PageHeader
        title={t('inventory.overview.title', 'Prezentare generală a inventarului')}
        description={t('inventory.overview.description', 'Vizualizați statistici și informații despre inventar')}
        actions={
          ...
          <CardContent>
            {loading.recentMaterials ? (
              ...
              <EmptyState
                ...
                description={t('inventory.noMaterialsDescription', 'Nu există materiale în inventar. Adăugați materiale pentru a le vedea aici.')}
                action={
            ...
            {loading.lowStockItems ? (
              ...
              <div className="text-center py-6">
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  {t('inventory.noLowStockItems', 'Nu există materiale cu stoc scăzut')}
                </p>
              </div>
            ) : (
          ...
          <CardContent>
            {loading.recentActivity ? (
              ...
              <div className="text-center py-6">
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  {t('inventory.noRecentActivityDescription', 'Nu există activitate recentă în inventar')}
                </p>
              </div>
            ) : (
              <div className="space-y-4">
